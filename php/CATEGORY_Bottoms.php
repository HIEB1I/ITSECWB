...
// Fetch products for the 'BOTTOMS' category
$sql = "SELECT * FROM PRODUCT WHERE Category = 'BOTTOMS'";
...
<head>
  <meta charset="UTF-8">
  <title>Bottoms ‒ KALYE WEST</title>
  <style>
...
<nav>
  ...
  <a href="CATEGORY_Bottoms.php" class="active">BOTTOMS</a>
  <a href="CATEGORY_Layering.php">LAYERING</a>
</nav>

<!-- HERO TITLE -->
<section class="hero">
  <h1><strong>KALYE WEST</strong> BOTTOMS</h1>
</section>
