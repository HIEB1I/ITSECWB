...
// Step 1: Check if the user already has an active cart (Purchased = FALSE)
...
// Step 4: Add the product to the CART_ITEMS table
...
if ($stmt_add_to_cart->execute()) {
    // Step 5: Update the cart's total after adding the product
